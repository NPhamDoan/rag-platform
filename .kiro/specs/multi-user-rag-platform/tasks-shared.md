...
- [ ] 15. Gói shared: types + API client contract
  - [ ] 15.1 Thiết lập gói shared + types
  ...
  - [ ] 15.2 createApiClient contract (Bearer + 401 + ánh xạ lỗi)
  ...
  - [ ] 15.3 Logic nghiệp vụ thuần dùng chung
  ...
  - [ ]* 15.4 fast-check test: ánh xạ marker nhất quán
